...
def entrypoint(argv : List[str])->None:
    ...
    parser.add_argument("-n","--names",help="filters the repositories by name",type=str)
    parser.add_argument("-p","--paths",help="filters the repositories by path",type=str)
    parser.add_argument("-a","--authors",help="filters the repositories by author",type=str)
    parser.add_argument("-t","--tags",help="filters the repositories by tags",nargs="*",type=str)
    parser.add_argument("-o","--origins",help="filters the repositories by origin",nargs="*",type=str)
    ...
    repositories_names = get_repositories_filtered(args.names, args.authors, args.paths, args.origins, args.tags)
    # init buffer
    buffer = ""
